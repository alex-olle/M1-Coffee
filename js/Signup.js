...
class Signup {
  constructor () {
    ...
    this.coffeeInput = document.querySelector("#coffee");
  ...
  saveData = (event) => {
    ...
    const coffee = this.coffeeInput.value;
    const email = this.emailInput.value;
    const password = this.passwordInput.value;
    const repeatPassword = this.repeatPasswordInput.value;

    const newUser = new User(name, coffee, email, password);
